...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-6 text-left text-base font-semibold text-foreground transition hover:text-accent [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
